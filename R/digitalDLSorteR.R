...
#' example, for quantifying the proportion of tumor infiltrated lymphocytes
#' (TILs) in breast cancer, by following this protocol you can obtain a specific
#' model for this type of samples. This fact overcomes the limitation of other
