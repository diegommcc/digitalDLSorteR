...
With `distErrorPlot`, we can plot in different ways how errors are distributed. In this case, we can see the absolute error (`AbsErr`) by cell type (`CellType`). CD4 T cell proportions are predicted worse than the other cell types, but still have a median error closse to zero. 
...
![plot of chunk distErr1_realModelExample](figure/distErr1_realModelExample-1.png)
...
![plot of chunk barError_realModelExample](figure/barError_realModelExample-1.png)
...
![plot of chunk distErr2_realModelExample](figure/distErr2_realModelExample-1.png)
...
![plot of chunk distErr3_realModelExample](figure/distErr3_realModelExample-1.png)
...
![plot of chunk corr1_realModelExample](figure/corr1_realModelExample-1.png)
...
![plot of chunk corr2_realModelExample](figure/corr2_realModelExample-1.png)
...
![plot of chunk bland1_realModelExample](figure/bland1_realModelExample-1.png)
...
![plot of chunk bland2_realModelExample](figure/bland2_realModelExample-1.png)
...
![plot of chunk barPlotResults_realModelExample](figure/barPlotResults_realModelExample-1.png)

As the total number of samples is too high, we can see the results of some samples by taking the matrix with the proportions and ploting 20 random samples with `barPlotCellTypes`:
...
![plot of chunk barPlotResults20_realModelExample](figure/barPlotResults20_realModelExample-1.png)
...
![plot of chunk boxplotsTypes_realModelExample](figure/boxplotsTypes_realModelExample-1.png)
