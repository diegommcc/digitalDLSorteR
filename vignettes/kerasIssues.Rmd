...
```{bash}
conda create --name r-reticulate-tensorflow python tensorflow=2.1
```
...
Finally, if [keras](https://cran.r-project.org/package=keras) still does not recognize the functional environment, set this new environment as the selected Python environment:
