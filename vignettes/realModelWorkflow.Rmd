...
```
## Error in eval(expr, envir, enclos): lazy-load database '/home/dmananesc/R/x86_64-pc-linux-gnu-library/4.3/digitalDLSorteR/R/digitalDLSorteR.rdb' is corrupt
```
...
```
## Error in eval(expr, envir, enclos): object 'DDLS.colon' not found
```
...
```
## Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'as.data.frame': error in evaluating the argument 'object' in selecting a method for function 'single.cell.real': object 'DDLS.colon' not found
```
...
```
## Warning in generateBulkCellMatrix(object = DDLS.colon, cell.ID.column = "Index", : restarting interrupted promise evaluation
```

```
## Warning in generateBulkCellMatrix(object = DDLS.colon, cell.ID.column = "Index", : internal error -3 in R_decompress1
```

```
## Error in generateBulkCellMatrix(object = DDLS.colon, cell.ID.column = "Index", : lazy-load database '/home/dmananesc/R/x86_64-pc-linux-gnu-library/4.3/digitalDLSorteR/R/digitalDLSorteR.rdb' is corrupt
```
...
```
## Error in h(simpleError(msg, call)): error in evaluating the argument 'data' in selecting a method for function 'barPlotCellTypes': object 'DDLS.colon' not found
```
...
```
## Error in h(simpleError(msg, call)): error in evaluating the argument 'object' in selecting a method for function 'deconv.results': object 'DDLS.colon' not found
```
...
```
## Error in h(simpleError(msg, call)): error in evaluating the argument 'data' in selecting a method for function 'barPlotCellTypes': object 'resDeconvTCGA' not found
```
...
```
## Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'rownames': object 'resDeconvTCGA' not found
```
...
```
## Error in interGradientsDL(DDLS.colon): could not find function "interGradientsDL"
```
...
```
## Error in topGradientsCellType(DDLS.colon, method = "class", top.n.genes = 5): could not find function "topGradientsCellType"
```
...
```
## Error in h(simpleError(msg, call)): error in evaluating the argument 'x' in selecting a method for function 'as.data.frame': error in evaluating the argument 'X' in selecting a method for function 'sapply': object 'top.gradients' not found
```
...
```
## Error in plotHeatmapGradsAgg(DDLS.colon, top.n.genes = 4, method = "class"): could not find function "plotHeatmapGradsAgg"
```
...
```
## Error in eval(expr, envir, enclos): object 'hh' not found
```
